...
def train_dino(args):
    ...
    backbone_arch = "vitb14" # change this to vitb14 when ready to really train
    backbone_name = f"dinov2_{backbone_arch}"

    student = torch.hub.load(repo_or_dir="facebookresearch/dinov2", model=f"dinov2_{backbone_arch}")
    teacher = torch.hub.load(repo_or_dir="facebookresearch/dinov2", model=f"dinov2_{backbone_arch}")
    embed_dim = student.head.out_features
    print(f'output embedding dims: {embed_dim}')
